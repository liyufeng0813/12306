...
class DamatuApi():
	...
	ID = '53209'
	KEY = '975bd424a8e1d83909bc408c8eec2f10'
...
dmt=DamatuApi(information.CODE_USER, information.CODE_PWD)
# #2.调用方法：
...
def codes(filepath, type):
    ...
    code_str = dmt.decode(filePath=filepath, type=type)
    code_str = code_str.replace('|', ',')
    code_list = code_str.split(',')
    x_list = code_list[0::2]
    y_list = code_list[1::2]
    s = ''
